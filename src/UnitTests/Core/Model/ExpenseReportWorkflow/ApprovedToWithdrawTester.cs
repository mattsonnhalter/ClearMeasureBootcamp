...
{
    [TestFixture]
    public class ApprovedToWithdrawTester : StateCommandBaseTester
    {
        [Test]
        public void ShouldNotBeValidInWrongStatus()
        {
            ...
            var command = new ApprovedToWithdrawCommand();
        ...
        public void ShouldNotBeValidWithWrongApprover()
        {
            ...
            var command = new ApprovedToWithdrawCommand();
            Assert.That(command.IsValid(new ExecuteTransitionCommand(report, null, differentEmployee, new DateTime())), Is.True);
        }
        ...
        public void ShouldSetLastApprovedEachTime()
        {
            ...
            var command2 = new ApprovedToWithdrawCommand();
        ...
        {
            return new ApprovedToWithdrawCommand();
        }
    }
}